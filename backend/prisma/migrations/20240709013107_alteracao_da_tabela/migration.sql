...
INSERT INTO "new_participants" ("email", "id", "is_confirmed", "is_owner", "name", "tripId", "trip_id") SELECT "email", "id", "is_confirmed", "is_owner", "name", "tripId", "trip_id" FROM "participants";
